      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8"><br>
            <input type="number" step="0.01" min="0" lang="en" min="0" step=".01" class="form-control input-sm" name="procenat" placeholder="{{ AdminOptions::lang(126, Session::get('jezik.AdminOptions::server()')) }} %" autocomplete="off">
          </div>
        </div>
        <div class="form-group row">
