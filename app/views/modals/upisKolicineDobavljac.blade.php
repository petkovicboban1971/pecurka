	   	...
	   	<div class="modal-content">
	        ...
	        <form method="post" action="/kolicinedobavljaca">
		        <div class="modal-body">
		        	...
		        	<input type="text" id="kolicina" style="float: right;" name="novaKolicina" size="9" placeholder="{{ AdminOptions::lang(124, Session::get('jezik.AdminOptions::server()')) }}" required disabled><br>
		        </div>
