   	...
   	<div class="modal-content">
        ...
        <form method="post" action="/dnevna_cena_proizvoda">
	        <div class="modal-body">
	        	<select name="proizvod" class="nacin_uplate" style="width: auto;font-weight: bold;" required>	  
	        	...
	        	<input type="number" step="0.01" min="0" lang="en" class="iznos_uplate" style="float: right; width: auto;" name="kolicina"  disabled required placeholder="{{ AdminOptions::lang(253, Session::get('jezik.AdminOptions::server()')) }}"><br><br>
	        </div> 
